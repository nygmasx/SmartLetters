                            ...
                            <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                                <div
                                    ...
                                    <div
                                        ...
                                        <Link type="button" href={route('letters.index')}
                                ...
                                <div className="overflow-x-auto">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" className="px-4 py-3">Diplôme</th>
                                            <th scope="col" className="px-4 py-3">Lettre</th>
                                        ...
                                        <tr className="border-b dark:border-gray-700">
                                            <th scope="row"
                                                className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white"></th>
                                            ...
                                            <td className="px-4 py-3">
                                                <button id="readProductButton" data-modal-toggle="readProductModal"
                                                        className="block text-white bg-blue-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                                                        type="button" data-letter-id="('{{ letter.id }}')">
                                                    Voir ma SmartLetter
                                                </button>
                                            </td>
